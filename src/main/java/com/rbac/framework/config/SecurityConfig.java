...
import com.rbac.framework.config.properties.PermitAllUrlProperties;
import com.rbac.framework.security.filter.JwtAuthenticationTokenFilter;
import com.rbac.framework.security.handle.AuthenticationEntryPointImpl;
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception
    {
        return httpSecurity
                ...
                .authorizeHttpRequests((requests) -> {
                    ...
                    requests.requestMatchers("/auth/**", "/system/**","/monitor/**", "/register", "/captchaImage").permitAll()
