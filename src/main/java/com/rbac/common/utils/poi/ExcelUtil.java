package com.rbac.common.utils.poi;

import com.rbac.common.annotation.Excel;
import com.rbac.common.annotation.Excel.ColumnType;
import com.rbac.common.annotation.Excel.Type;
import com.rbac.common.annotation.Excels;
import com.rbac.common.config.rbacConfig;
import com.rbac.common.core.domain.AjaxResult;
import com.rbac.common.core.text.Convert;
import com.rbac.common.exception.UtilException;
import com.rbac.common.utils.DateUtils;
import com.rbac.common.utils.DictUtils;
import com.rbac.common.utils.StringUtils;
import com.rbac.common.utils.file.FileTypeUtils;
import com.rbac.common.utils.file.FileUtils;
import com.rbac.common.utils.file.ImageUtils;
import com.rbac.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public List<T> importExcel(InputStream is)
    {
        ...
        {
            log.error("Error occurred while importing Excel {}", e.getMessage());
    ...
    public void exportExcel(HttpServletResponse response)
    {
        ...
        {
            log.error("Error occurred while exporting Excel {}", e.getMessage());
        }
        finally
        {
    ...
    public AjaxResult exportExcel()
    {
        ...
        {
            log.error("Error occurred while exporting Excel {}", e.getMessage());
            throw new UtilException("Excel export failed, please contact the website administrator!");
        }
        finally
        {
            IOUtils.closeQuietly(wb);
    ...
    {
        String downloadPath = rbacConfig.getDownloadPath() + filename;
    ...
    public Method getSubMethod(String name, Class<?> pojoClass)
    {
        ...
        {
            log.error("Error occurred while retrieving the object {}", e.getMessage());
        }
        return method;
    }
}
