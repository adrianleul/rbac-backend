...
import com.rbac.common.annotation.DataScope;
import com.rbac.common.constant.UserConstants;
import com.rbac.common.core.domain.entity.SysRole;
...
import com.rbac.system.mapper.SysRoleDeptMapper;
...
public class SysRoleServiceImpl implements ISysRoleService
{
    ...
    public void checkRoleAllowed(SysRole role)
    {
        ...
        {
            throw new ServiceException("Operation on super administrator roles is not allowed");
        }
    }
    ...
    public int deleteRoleByIds(Long[] roleIds)
    {
        for (Long roleId : roleIds)
        {
            ...
            {
                throw new ServiceException(String.format("%1$s is already assigned and cannot be deleted", role.getRoleName()));
            }
        }
