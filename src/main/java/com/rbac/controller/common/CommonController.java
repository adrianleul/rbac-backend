package com.rbac.controller.common;
...
import com.rbac.common.utils.file.FileUploadUtils;
import com.rbac.common.utils.file.FileUtils;
import com.rbac.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = rbacConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // Upload file path
            String filePath = rbacConfig.getUploadPath();
            ...
            throws Exception
    {
        try
        {
            ...
            // local resource path
            String localPath = rbacConfig.getProfile();
