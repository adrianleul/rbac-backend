package com.rbac.framework.aspectj;
...
import com.rbac.common.enums.RequestStatus;
import com.rbac.common.enums.HttpMethod;
import com.rbac.common.filter.PropertyPreExcludeFilter;
...
public class LogAspect
{
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult)
    {
        try
        {
            ...
            operLog.setStatus(RequestStatus.SUCCESS.ordinal());
            ...
            if (e != null)
            {
                operLog.setStatus(RequestStatus.FAIL.ordinal());
        ...
        {
            log.error("Error message: {}", exp.getMessage());
            exp.printStackTrace();
        }
        finally
        {
